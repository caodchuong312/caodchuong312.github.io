...
![image](https://hackmd.io/_uploads/BJi8z6Fs0.png)

Check discord:

![image](https://hackmd.io/_uploads/HJ6dfTti0.png)

> Flag: `KMACTF{KMACTF2024_h4s_b3gun}`

## pickleball

![image](https://hackmd.io/_uploads/HyfZQ2FjC.png)

Bài này flag được chia làm 3 phần
- Phần 1: nằm trong `/robots.txt`:

![image](https://hackmd.io/_uploads/S1HuQ2FjA.png)

>KMACTF{p1Ckleb4ll_

- Phần 2: nằm trong file js: `/assets/index-f7659d98.js`

![image](https://hackmd.io/_uploads/H11JVhKiC.png)
...
![image](https://hackmd.io/_uploads/H1YmN3KsR.png)
...
![image](https://hackmd.io/_uploads/BJpkd2YjR.png)

- IPv4:

![image](https://hackmd.io/_uploads/Hybhunts0.png)
...
![image](https://hackmd.io/_uploads/r1cb9htoA.png)
...
![image](https://hackmd.io/_uploads/r119epKjR.png)
...
![image](https://hackmd.io/_uploads/ByHFWaYsR.png)
...
![image](https://hackmd.io/_uploads/ryf3ZaFs0.png)
...
![image](https://hackmd.io/_uploads/HyDSGptoA.png)

Đây là ứng dụng viết bằng spring, đầu tiền add lib trên IntelliJ IDEA để xem file `jar`


![image](https://hackmd.io/_uploads/ryBgSpKoA.png)

![image](https://hackmd.io/_uploads/rJcQHatiC.png)


Theo Dockerfile, để lấy flag thì phải RCE:

![image](https://hackmd.io/_uploads/S1hZrTYsR.png)

Chạy docker:

![image](https://hackmd.io/_uploads/BJBy8aFiA.png)
...
- `@GetMapping({"testUI"})`: giao diện upload file
    ...
    ![image](https://hackmd.io/_uploads/H1te5TtjA.png)
...
![image](https://hackmd.io/_uploads/rJvPD6YsC.png)

Điều này xảy ra lỗ hổng đọc file bất kỳ.

![image](https://hackmd.io/_uploads/Skc3wptiA.png)
...
![image](https://hackmd.io/_uploads/HJpssTYo0.png)


![image](https://hackmd.io/_uploads/HJbpopKjC.png)
...
![image](https://hackmd.io/_uploads/HJ-u36FiC.png)

Test:

![image](https://hackmd.io/_uploads/rJ4X0TFsR.png)

![image](https://hackmd.io/_uploads/B1GSCatiC.png)
...
![image](https://hackmd.io/_uploads/rySvBAqj0.png)
...
![image](https://hackmd.io/_uploads/HykiE39j0.png)
Và sửa command RCE trong class `IBM33722`:

![image](https://hackmd.io/_uploads/rJEsAocsC.png)
...
![image](https://hackmd.io/_uploads/HkQwrncoA.png)

![image](https://hackmd.io/_uploads/r1PDH2csA.png)
Và replace 2 file cũ và thực hiện compress lại: `jar -cvmf META-INF/MANIFEST.MF charsets.jar ./*`
Upload file:
![image](https://hackmd.io/_uploads/r1Vzb2csR.png)


Request trigger:

![image](https://hackmd.io/_uploads/Hk9Txn5oA.png)

Có thể thấy trong log:
![image](https://hackmd.io/_uploads/Hk9Kencs0.png)

Khi thực hiện lại request sẽ biết nó không load lại file jar, như vậy nó chỉ load 1 lần để dùng.
Kết quả:

![image](https://hackmd.io/_uploads/SJT7l3ciC.png)


Bây giờ chỉ việc thực hiện trên server thật và lấy flag:

![image](https://hackmd.io/_uploads/rkkaMnqoA.png)
